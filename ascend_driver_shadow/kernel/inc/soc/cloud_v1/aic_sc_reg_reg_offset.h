...
#define SOC_AIC_SC_REG_SCALER_BUFFER_OVERFLOW_KERNEL_CODE          (0x43fe0)
#define SOC_AIC_SC_REG_SCALER_BUFFER_OVERFLOW_BLOCK_IDX            (0x43fe8)
#define SOC_AIC_SC_REG_SCALER_BUFFER_OVERFLOW_STATUS               (0x43ff0)
